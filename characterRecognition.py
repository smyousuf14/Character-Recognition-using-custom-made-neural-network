...
class Network:
    def __init__(self,sizes):
        ...
        self.wieghts = [np.random.randn(y,x) for x,y in zip(sizes[:-1], sizes[1:])]

    def feedforward(self, a):
        #Return the output of the network if "a" is input.
        for b,w in zip(self.biases,  self.wieghts):
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        self.wieghts = [w-(eta/len(mini_batch)) * nw
                        for w,nw in zip(self.wieghts, nabla_w)]
